...
class SplitLayersUI(QtWidgets.QWidget):
    def __init__(self):
        ...
        if nuke.NUKE_VERSION_MAJOR < 16:
            ...
            method_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight | QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        if nuke.NUKE_VERSION_MAJOR < 16:
            ...
            alpha_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight | QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        if nuke.NUKE_VERSION_MAJOR < 16:
            ...
            self.input_listview.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection) 
        ...
        if nuke.NUKE_VERSION_MAJOR < 16:
            ...
            self.split_listview.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
